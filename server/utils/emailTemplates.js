...
<div style="max-width: 600px; margin: auto; background-color: #f4f4f4; padding: 20px; border-radius: 10px; box-shadow: 0 2px 4px rgb(104, 182, 255);">
  <div style="background-color: #ffffff; padding: 20px; border-radius: 10px;">
    <img src="https://raw.githubusercontent.com/shanupalash/AumniEcho---University-Alumni-Connect-Platform-/33e8e6cfa68dfd5aae963fdb5c25708ca2cae6b9/client/src/assets/logo1.png
" alt="AlumniEcho Logo" style="display: block; margin: auto auto 20px; max-width: 50%;">
    <p style="font-size: 18px; margin-bottom: 20px; text-align: center; color: #4b5563; font-weight: bold;">Welcome to AlumniEcho, ${name}!</p>
